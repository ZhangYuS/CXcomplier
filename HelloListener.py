...
class HelloListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by HelloParser#expression.
    def enterExpression(self, ctx:HelloParser.ExpressionContext):
        pass

    # Exit a parse tree produced by HelloParser#expression.
    def exitExpression(self, ctx:HelloParser.ExpressionContext):
        pass
